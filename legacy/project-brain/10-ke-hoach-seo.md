...
| Hướng dẫn Ứng Kỳ | `/huong-dan/ung-ky` (đề xuất 2026-09-05) | Bài thuần lý luận, KHÔNG có tính năng nào của QIChing tính hay hiển thị Ứng Kỳ để đối chiếu — rủi ro nội dung sai lệch cao hơn 3 bài trên, domain reviewer cần duyệt kỹ hơn trước khi tính đến việc index. Cần phân biệt rõ với `/tim-ngay-tot` (quét ngày *trước khi* hành động, khác Ứng Kỳ là luận thời điểm ứng nghiệm *sau khi* đã có quẻ) |
