...
> **Trạng thái triển khai — review 31/08/2026:** Luồng chọn cách khởi quẻ, hai cách gieo,
> gieo đủ sáu hào, màn review và kết quả dùng chung đã được triển khai. IA thực tế tuân theo
> tài liệu merge mới hơn, nên thứ tự `Cách khởi quẻ → Câu hỏi → Cách gieo` thay thế flow v1
> ở Section 2/6. Callback huỷ hiện đã reset trạng thái cha nhưng chưa có regression test; các
> phần chưa đạt gồm bảo vệ khi rời qua top navigation, ký hiệu hào động không phụ
> thuộc màu, tooltip dùng bàn phím/touch, chi tiết hào động trên card đã lưu và kiểm thử UI.
> Xem [`09-gop-gieo-dong-xu-vao-xem-que.md`](./09-gop-gieo-dong-xu-vao-xem-que.md).
