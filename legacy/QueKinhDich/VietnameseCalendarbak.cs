...
namespace System.Globalization
{
	...
	public class VietnameseCalendar : Calendar
	{
        ...
        public virtual string GetYearName(int year, out String selestial, out String teresstrial)
        {
            this.CheckYearRange(year);
        ...
        public virtual string GetDayName(DateTime date,out String selestial,out String teresstrial)
        {
            this.CheckTicksRange(date.Ticks);
            int jd = (int)Math.Floor(JulianDayNumber(date));
        ...
        public virtual string GetMonthName(int year, int month, out String selestial, out String teresstrial)
        {
            int leapMonth = this.GetLeapMonth(year, 0);
            this.CheckMonthRange(month, leapMonth);
            int i = ((leapMonth > 0 && month >= leapMonth) ? -1 : 0);
